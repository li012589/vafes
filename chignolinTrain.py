...
if __name__ == "__main__":
    ...
    group.add_argument("-batch", type=int, default=128, help="batch size")
    ...
    group.add_argument("-K", type=int, default=32, help="bin number of nsf flow")
    group.add_argument("-mlpVector", default=[512, 1024, 1024], type=int, nargs="+", help="hidden dim of MLP used in spline flow")
    group.add_argument("-couplingLayer1", type=int, default=14, help="how many coupling layers")
    group.add_argument("-couplingLayer2", type=int, default=8, help="how many coupling layers")
    group.add_argument("-kernelSize", type=int, default=25, help="size of the cnn kernels")
    group.add_argument("-channels", type=int, default=256, help="hidden channel dimension")
    group.add_argument("-hiddenChannels", type=int, default=128, help="hidden channel dimension")
    group.add_argument("-hiddenConvLayers", type=int, default=8, help="num of hidden cnn layers")
    group.add_argument("-hiddenWidth", type=int, default=128, help="dimension of the hidden mlp")
    group.add_argument("-hiddenFcLayers", type=int, default=4, help="num of hidden Fc layers")
    ...
    group.add_argument("-beta", type=float, default=0.35, help="temperature")
    group.add_argument("-betalow", type=float, default=0.6, help="low temperature start point in training")
